...
class Link {
  ...
  // Chain constructor
  Link(Object p1_, Object p2_, float distance) {
    init(p1_, p2_, distance, frequencyHz, dampingRatio);
  }
  
  Link(Object p1_, Object p2_, float distance, float frequencyHz_, float dampingRatio_) {
    init(p1_, p2_, distance, frequencyHz_, dampingRatio_);
  }
  
  void init(Object p1_, Object p2_, float len_, float frequencyHz_, float dampingRatio_){
    p1 = p1_;
    p2 = p2_;
  ...
  DistanceJoint makeDistanceJoint(Object p1, Object p2, float len_, float frequencyHz_, float dampingRatio_) {
