...
class Boundary {
  ...
  Boundary(float x_, float y_, float w_, float h_, float a_, color cFill_, color cStroke_) {
    init(x_, y_, w_, h_, a_, cFill_, cStroke_, strokeW);
  }

  Boundary(float x_, float y_, float w_, float h_, float a_, color cFill_, color cStroke_, float strokeW_) {
    init(x_, y_, w_, h_, a_, cFill_, cStroke_, strokeW_);
  }
